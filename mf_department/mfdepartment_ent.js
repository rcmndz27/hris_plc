$(function(){
    ...
    $('#mfdepartmentEntry').click(function(e){
        e.preventDefault();
    ...
    $('#Submit').click(function(){
        ...
        if (CheckInput() === true) {
            ...
            // exit();
                     ...
                     swal({
                          title: "Are you sure ?",
                          text: "You want to add this department.",
                          icon: "success",
                          buttons: true,
                          dangerMode: true,
                        })
                        .then((appEnt) => {
                          if (appEnt) {
                                    $.ajax({
                                        type: 'POST',
                                        url: '../mf_department/mfdepartmentent_process.php',
                                        data: {
                                            data: param
                                        },
                            ...
                            swal({text:"You cancel the addition of the department!",icon:"error"});
                          }
                        });
