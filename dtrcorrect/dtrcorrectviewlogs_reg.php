<?php  
 ...
 function GetDtrCorrectLogs($lvlogid){
        ...
        <thead>
            <tr>
                <th colspan="4" class ="text-center">DTR Correction Logs</th>
            </tr>
            <tr>
                <th>Remarks</th>
                <th>User Name</th>
        ...
        $query = "SELECT * FROM dbo.logs_dtrc where dtrc_id = :lvlogid ORDER BY auditdate ASC";
