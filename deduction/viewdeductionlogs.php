<?php
 ...
 function ViewDedLogs($emp_code){
        
        global $connL;

        echo '
        <table id="ViewDedLogs" class="table table-striped table2">
        <thead>
            <tr>
                <th colspan="11" class ="text-center">Deduction Logs</th>
            </tr>
            <tr>
                <th>Emp Code</th>
                <th>Emp Name</th>
        ...
        $query = "SELECT * FROM logs_mfded where emp_code = :emp_code ORDER BY auditdate ASC";
