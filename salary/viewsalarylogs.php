<?php
 ...
 function ViewSalaryLogs($emp_code){
        
        global $connL;

        echo '
        <table id="ViewSalaryLogs" class="table table-striped table2">
        <thead>
            <tr>
                <th colspan="11" class ="text-center">Salary Logs</th>
            </tr>
            <tr>
                <th>Emp Code</th>
                <th>Emp Name</th>
        ...
        $query = "SELECT * FROM logs_mfsal where emp_code = :emp_code ORDER BY auditdate ASC";
