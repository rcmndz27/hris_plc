...
function insertMfSalLogs($emp_code,$emp_name,$column_name,$new_data,$old_data,$empCode)
    ...
    {    
        ...
        $querys = "INSERT INTO logs_mfsal (emp_code,emp_name,column_name,new_data,old_data,audituser,auditdate) 
