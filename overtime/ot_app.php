...
Class OtApp{
    ...
    public function InsertAppliedOtApp($empCode,$empReportingTo,$otDate,$otStartDtime,$otEndDtime,$remarks,$e_req,$n_req,$e_appr,$n_appr){
        ...
        $mail->Body    = '<h1>Hi '.$napprover.' </b>,</h1>An employee has requested a overtime(#'.$rst['maxid'].').<br><br>
                        ...
                        <a href="http://124.6.185.87:6868/hris_obanana/overtime/overtime-approval-view.php">Overtime Approval List</a> 
                        <br><br></h2>
                        ...
                        <h6>If you are having trouble clicking the "Overtime Approval List" button, copy and paste the URL below into your web browser: http://124.6.185.87:6868/hris_obanana/overtime/overtime-approval-view.php <h6>
                       ';
            $mail->send();
