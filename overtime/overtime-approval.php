...
require '../vendor/autoload.php';
    ...
    Class OvertimeApproval{
        ...
        $mail->Body    = '<h1>Hi '.$nrequester.' </b>,</h1>Your overtime request #'.$rowid.' has been approved.<br><br>
                        ...
                        <a href="http://203.177.143.61:8080/hris_obanana/overtime/ot_app_view.php">Overtime Request List</a> 
                        <br><br></h2>
                        ...
                        <h6>If you are having trouble clicking the "Overtime Request List" button, copy and paste the URL below into your web browser: http://203.177.143.61:8080/hris_obanana/overtime/ot_app_view.php <h6>
                       ';
            $mail->send();
        ...
        $mail->Body    = '<h1>Hi '.$nrequester.' </b>,</h1>The overtime request #'.$rowid.' has been forwarded to you for your approval.<br><br>
                        ...
                        <h2>Check the request in :
                        <a href="http://203.177.143.61:8080/hris_obanana/overtime/ot_app_view.php">Overtime Approval List</a> 
                        <br><br></h2>
                        ...
                        <h6>If you are having trouble clicking the "Overtime Approval List" button, copy and paste the URL below into your web browser: http://203.177.143.61:8080/hris_obanana/overtime/ot_app_view.php <h6>
                       ';
            $mail->send();
            // echo 'Message has been sent';
            } catch (Exception $e) {
