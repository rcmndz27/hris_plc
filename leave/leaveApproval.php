...
require '../vendor/autoload.php';
    ...
    function ApproveLeave($employee,$curApproved,$curDateFrom,$curDateTo,$curLeaveType,$rowid,$approver,$empcode){
        ...
        $mail->Body    = '<h1>Hi '.$nrequester.' </b>,</h1>Your leave request #'.$rowid.' has been approved.<br><br>
                        ...
                        <a href="http://124.6.185.87:6868/hris_obanana/leave/leaveApplication_view.php">Leave Request List</a> 
                        <br><br></h2>
                        ...
                        <h6>If you are having trouble clicking the "Leave Request List" button, copy and paste the URL below into your web browser: http://124.6.185.87:6868/hris_obanana/leave/leaveApplication_view.php <h6>
                       ';
            $mail->send();
