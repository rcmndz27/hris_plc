...
require '../vendor/autoload.php';
    ...
    Class WfhApproval{
        ...
        $mail->Body    = '<h1>Hi '.$nrequester.' </b>,</h1>Your work from home request #'.$rowId.' has been approved.<br><br>
                        ...
                        <a href="http://124.6.185.87:4200/hris_plc/wfhome/wfh_app_view.php">Work from Home Request List</a> 
                        <br><br></h2>
                        ...
                        <h6>If you are having trouble clicking the "Work from Home Request List" button, copy and paste the URL below into your web browser: http://124.6.185.87:4200/hris_plc/wfhome/wfh_app_view.php <h6>
                       ';
            $mail->send();
...
function FwdWfh($empReportingTo,$empId,$approver,$rowid){
        ...
        $mail->Body    = '<h1>Hi '.$nrequester.' </b>,</h1>The work from home request #'.$rowid.' has been forwarded to you for your approval.<br><br>
                        ...
                        <h2>Check the request in :
                        <a href="http://124.6.185.87:4200/hris_plc/wfhome/wfh_app_view.php">Work from Home Approval List</a> 
                        <br><br></h2>
                        ...
                        <h6>If you are having trouble clicking the "Work from Home Approval List" button, copy and paste the URL below into your web browser: http://124.6.185.87:4200/hris_plc/wfhome/wfh_app_view.php <h6>
                       ';
            $mail->send();
            // echo 'Message has been sent';
            } catch (Exception $e) {
