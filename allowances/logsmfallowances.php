...
function insertMfAlwLogs($emp_code,$emp_name,$column_name,$new_data,$old_data,$empCode)
    ...
    {    
        ...
        $querys = "INSERT INTO logs_mfalw (emp_code,emp_name,column_name,new_data,old_data,audituser,auditdate) 
                VALUES(:emp_code,:emp_name,:column_name,:new_data,:old_data,:audituser,:auditdate)";
